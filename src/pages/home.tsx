    ...
    <div className='home'>
      <div className="card">
        <div className="card-body">
          ...
          <h4 className="text-center mt-4">You can join a game using a game code or create a new game and invite your friends.
          </h4>
          <br />
          <br />
          <br />
          <div className="d-flex align-items-center justify-content-center mt-5">
            ...
            <a className="btn btn-info btn-lg" href="/game">Create new game</a>
          </div>
        </div>
      </div>
    </div>
